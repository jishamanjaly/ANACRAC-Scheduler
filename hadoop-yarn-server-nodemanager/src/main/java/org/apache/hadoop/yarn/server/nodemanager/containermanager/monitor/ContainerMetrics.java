...
public class ContainerMetrics implements MetricsSource {
  ...
  //JISHA
  public static Map<ContainerId, ContainerMetrics> getUsageMetrics(){
	  return usageMetrics;
  }
  //JISHA
  public static ContainerMetrics getContainerUsageMetrics(ContainerId cid){
	  return usageMetrics.get(cid);
  }
}
