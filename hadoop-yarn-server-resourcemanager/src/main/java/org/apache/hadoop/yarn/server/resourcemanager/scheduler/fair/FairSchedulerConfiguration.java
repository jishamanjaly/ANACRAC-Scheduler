...
public class FairSchedulerConfiguration extends Configuration {
  ...
  private static final String TAS_CONF_PREFIX =  "yarn.scheduler.tas.";
  ...
  /** Allowed Host Names */
  // JISHA
  protected static final  String ALLOWED_HOSTS = TAS_CONF_PREFIX + "hosts";
  protected static final  String DEFAULT_ALLOWED_HOSTS = "ALL";
  
  /** Allowed number of tasks per node */
  // JISHA
  protected static final  String TASKS_HOST = TAS_CONF_PREFIX + "tasks.maximum";
  protected static final  int DEFAULT_ALLOWED_TASK_NUM = -1;
  
  
  /** JOB TYPE Settings for Scheduler - IO/CPU/ALL */
  // JISHA
  protected static final  String JOB_TYPE = TAS_CONF_PREFIX + "job.type";
  protected static final  String DEFAULT_JOB_TYPE = "NONE";

  /** IO JOB TYPE threshold Settings for Scheduler */
  // JISHA
  protected static final String IO_THRESHOLD = TAS_CONF_PREFIX + "io.threshold";
  protected static final  float DEFAULT_IO_THRESHOLD = 75f;
  
  /** CPU JOB TYPE threshold Settings for Scheduler */
  // JISHA
  protected static final String CPU_THRESHOLD = TAS_CONF_PREFIX + "cpu.threshold";
  protected static final  float DEFAULT_CPU_THRESHOLD = 75f;
  
  /** Container JOB TYPE Settings for Scheduler - cpu/memory/all */
  // JISHA
  protected static final  String CONTAINER_JOB_TYPE = TAS_CONF_PREFIX + "container.job.type";
  protected static final  String DEFAULT_CONTAINER_JOB_TYPE = "NONE";
  
  /** IO JOB TYPE Container memory threshold Settings for Scheduler */
  // JISHA
  protected static final String CONTAINER_MEMORY_THRESHOLD = TAS_CONF_PREFIX + "container.memory.threshold";
  protected static final  float DEFAULT_CONTAINER_MEMORY_THRESHOLD = 75f;
  
  /** IO JOB TYPE Container memory increment Settings for Scheduler in MB's*/
  // JISHA
  protected static final String CONTAINER_MEMORY_INCREMENT = TAS_CONF_PREFIX + "container.memory.increment";
  protected static final  int DEFAULT_CONTAINER_MEMORY_INCREMENT = 1024;
  
  /** CPU JOB TYPE Container cpu threshold Settings for Scheduler */
  // JISHA
  protected static final String CONTAINER_CPU_THRESHOLD = TAS_CONF_PREFIX + "container.cpu.threshold";
  protected static final  float DEFAULT_CONTAINER_CPU_THRESHOLD = 75f;
  
  /** CPU JOB TYPE Container cpu increment Settings for Scheduler */
  // JISHA
  protected static final String CONTAINER_CPU_INCREMENT = TAS_CONF_PREFIX + "container.cpu.increment";
  protected static final  int DEFAULT_CONTAINER_CPU_INCREMENT = 1;
...
//	    return getStrings(ALLOWED_HOSTS, DEFAULT_ALLOWED_HOSTS);
//  }
//  //JISHA
//  public float getCPUThreshold() {
//	    return getFloat(CPU_THRESHOLD, DEFAULT_CPU_THRESHOLD);
//	  }
//  //JISHA
//  public float getIOThreshold() {
//	    return getFloat(IO_THRESHOLD, DEFAULT_IO_THRESHOLD);
//	  }
//  //JISHA
//  public String getJobType() {
//	    return get(JOB_TYPE,DEFAULT_JOB_TYPE);
//	  }
//  // JISHA
//  public int getMaxTasksInNode() {
//	    return getInt(TASKS_HOST, DEFAULT_ALLOWED_TASK_NUM);
//  }
