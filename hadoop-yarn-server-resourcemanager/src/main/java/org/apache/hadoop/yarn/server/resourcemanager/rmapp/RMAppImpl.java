...
public class RMAppImpl implements RMApp, Recoverable {
  ...
  public RMAppImpl(ApplicationId applicationId, RMContext rmContext,
   ...
   LOG.info("Configuration from RMAppImpl : \n "+ conf.toString());
  }
...
//  //JISHA
//  @Override
//  public Configuration getRMAppConfiguration(){
//	  return conf;
//  }
  ...
  public Path getJobConfFile(){
	String appId = this.applicationId.toString();
	String job_name = "job_"+appId.split("_",2)[1];
    String job_xml = "job.xml";
    String stage_dir = conf.get("yarn.app.mapreduce.am.staging-dir");
    String hdfs_base_path = conf.get("fs.defaultFS");
  ...
  public Configuration getRMAppConfiguration(){
	if(null == jobConf){
		...
		if(null == jobConf){
			LOG.info("JISHA : ERROR while loading Job Configuration from path : " + confPath.toString());
		}
	}
    return jobConf;  
  }
