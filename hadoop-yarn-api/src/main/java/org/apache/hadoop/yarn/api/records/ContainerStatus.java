...
public abstract class ContainerStatus {
  ...
  public static ContainerStatus newInstance(ContainerId containerId,
      ContainerState containerState, String diagnostics, int exitStatus, double cpuUsage, double memoryUsage) { //JISHA
    ContainerStatus containerStatus = Records.newRecord(ContainerStatus.class);
    containerStatus.setState(containerState);
    containerStatus.setContainerId(containerId);
    containerStatus.setDiagnostics(diagnostics);
    containerStatus.setExitStatus(exitStatus);
    containerStatus.setCpuUsage(cpuUsage); // JISHA
    containerStatus.setMemoryUsage(memoryUsage);
  ...
  public abstract void setCpuUsage(double cpuUsage);
  public abstract void setMemoryUsage(double memoryUsage);
}
