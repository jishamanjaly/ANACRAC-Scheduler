...
import org.apache.hadoop.yarn.proto.YarnServerCommonProtos.NodeResourceStatusProto;
...
public class NodeStatusPBImpl extends NodeStatus {
  ...
  private NodeResourceStatus nodeResourceStatus = null;
  ...
  private synchronized void mergeLocalToBuilder() {
    ...
    if (this.nodeResourceStatus != null) {
    	builder.setNodeResourceStatus(convertToProtoFormat(this.nodeResourceStatus));
      }
  ...
  private NodeResourceStatusProto convertToProtoFormat(NodeResourceStatus c) {
	    return ((NodeResourceStatusPBImpl)c).getProto();
	  }
    
  private NodeResourceStatusPBImpl convertFromProtoFormat(NodeResourceStatusProto c) {
	    return new NodeResourceStatusPBImpl(c);
	  }
...
public void setNodeResourceStatus(NodeResourceStatus nodeResourceStatus) {
    maybeInitBuilder();
    if (nodeResourceStatus == null) {
      builder.clearNodeResourceStatus();
    }
...
//JISHA
@Override
public synchronized NodeResourceStatus getNodeResourceStatus() {
    NodeStatusProtoOrBuilder p = viaProto ? proto : builder;
    if (this.nodeResourceStatus != null) {
      return this.nodeResourceStatus;
    }
    if (!p.hasNodeResourceStatus()) {
      return null;
    }
    this.nodeResourceStatus = convertFromProtoFormat(p.getNodeResourceStatus());
    return this.nodeResourceStatus;
  }
