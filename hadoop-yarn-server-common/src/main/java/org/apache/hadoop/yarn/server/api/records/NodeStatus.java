...
public abstract class NodeStatus {
  ...
  public static NodeStatus newInstance(NodeId nodeId, int responseId,
    ...
    //JISHA
    nodeStatus.setNodeResourceStatus(nodeResourceStatus);
    return nodeStatus;
  }
  ...
  //JISHA 
  public abstract void setNodeResourceStatus(NodeResourceStatus nodeResourceStatus);
  public abstract NodeResourceStatus getNodeResourceStatus();
}
